classdef testProcessing < matlab.unittest.TestCase
    properties
        proc
        collector
        Set
    ...
    methods(Test)
        ...
        function test_max_accx(testCase)
            testCase.proc.apply_process(testCase.collector, testCase.Set, @max_accx);
            testCase.assertEqual(testCase.collector.calculated.max_acceleration, [4;501;100]);
        end
    end
end
