function basic_gui
    ...
    filepath = uicontrol('Style', 'pushbutton', 'String', 'path to datafiles',...
                        'Position', [25,260,100,25], 'Callback',{@filepath_Callback});
    headerlines = uicontrol('Style', 'edit', 'String', '# header lines',...
                            'Position', [25,230,80,20], 'Callback',{@headerlines_Callback});
    filelist = uicontrol('Style', 'listbox',...
                        'Position', [25,45,400,160]);
    submit_button = uicontrol('Style', 'pushbutton', 'String', 'Done',...
                            'Position', [390,10,50,25],'Callback',{@submit_button_Callback});
...
%         filelist_selected = filelist_all(index_selected); %this probably won't work
        test = dropSet('test', dropSet_filepath, dropSet_headerlines, true)
    end
